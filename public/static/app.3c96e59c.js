                ...
                case 'logs':
                    try {
                        ...
                        if (!window.TitanModules.LogsModule) {
                            ...
                            await new Promise((resolve, reject) => {
                                script.onload = resolve;
                                script.onerror = () => reject(new Error('خطا در بارگذاری logs.js'));
                                document.head.appendChild(script);
                            });
                        }
                        ...
                        this.showAlert('خطا: ' + error.message, 'error');
                        mainContent.innerHTML = '<div class="text-center p-8 text-red-400">خطا: ' + error.message + '</div>';
                    }
                    break;
